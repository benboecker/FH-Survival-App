...
extension ImageGalleryView: UICollectionViewDataSource {
	...
	func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
		guard let image = self.delegate?.imageGalleryView(self, imageAtIndex: indexPath.row) else {
			return UICollectionViewCell()
		}

		let cell = collectionView.dequeueReuseableCell(indexPath: indexPath) as ImageCollectionViewCell
...
class ImageCollectionViewCell: UICollectionViewCell, Reuseable {
